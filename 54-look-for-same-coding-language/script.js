...
var list1 = [
  { firstName: "Daniel", lastName: "J.", country: "Aruba", continent: "Americas", age: 42, language: "JavaScript" },
  { firstName: "Kseniya", lastName: "T.", country: "Belarus", continent: "Europe", age: 22, language: "JavaScript" },
  { firstName: "Hanna", lastName: "L.", country: "Hungary", continent: "Europe", age: 65, language: "Ruby" },
];

function isAllLanguagesSame(array) {
  let currentLanguage = array[0].language;
  return array.every(e => e.language === currentLanguage);
}

isAllLanguagesSame(list1);
