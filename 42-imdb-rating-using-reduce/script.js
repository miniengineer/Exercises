...
var directorNolan = watchList.filter(element => element.Director === "Christopher Nolan" );
var imdbRating = directorNolan.map(element => Number(element.imdbRating));

var averageRating = imdbRating.reduce((a,b) => a += b) / imdbRating.length;
